...
const authToken = "Your_Twilio_AuthToken";
const twilioPhoneNumber = "Your_Twilio_PhoneNumber";
    ...
    async (req, res) => {
        ...
        try {
            ...
            await client.messages.create({
                body: `Your OTP code is ${otp}. Thank you for Choosing Service Booking.You can view your booking details here: ${bookingLink}`,
